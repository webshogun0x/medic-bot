...
// SD Card Module (SPI3 / HSPI Bus)
#define SD_SPI_HOST             SPI3_HOST
#define PIN_SD_MISO             GPIO_NUM_12
...
#define PIN_FP_RX               GPIO_NUM_16  // ESP32 RX <- Sensor TX
#define PIN_FP_TX               GPIO_NUM_17  // ESP32 TX -> Sensor RX
#define FP_BAUDRATE             57600
#define FP_RX_BUF_SIZE          512

// MFRC522 RFID Reader (SPI2 / FSPI Bus)
#define RFID_SPI_HOST           SPI2_HOST
#define PIN_RFID_SCK            GPIO_NUM_18
#define PIN_RFID_MISO           GPIO_NUM_19
#define PIN_RFID_CS             GPIO_NUM_21
#define PIN_RFID_MOSI           GPIO_NUM_11
#define PIN_RFID_RST            GPIO_NUM_47
...
/* =========================================================================
 * Network Configuration — credentials stored in NVS at runtime;
 * these are build-time defaults only.
 * ========================================================================= */
...
// Firebase REST API — set real values via menuconfig / NVS
#define FIREBASE_HOST_DEFAULT   ""
#define FIREBASE_API_KEY_DEF    ""
...
#define ESPNOW_REQUEST_CMD      0xAA             // Height/Weight data request byte
...
#define CORE_REALTIME_APP       1   // Core 1: FSM, Display, Sensors, Auth
...
#define CLOUD_SYNC_INTERVAL_MS  60000   // 1 minute between sync sweeps
#define RFID_POLL_INTERVAL_MS   200     // 5 Hz polling when active
